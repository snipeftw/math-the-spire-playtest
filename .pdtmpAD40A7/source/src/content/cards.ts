...
export const BASE_CARDS: CardDef[] = [
  ...
  { id: "skl_confidence", name: "Confidence", type: "SKILL", cost: 2, rarity: "Rare", desc: "Your next attack deals double damage.", effect: { kind: "double_next_attack" } },
...
export const UPGRADED_CARDS: CardDef[] = [
  ...
  { id: "skl_confidence_u", upgradeOf: "skl_confidence", name: "Confidence+", type: "SKILL", cost: 1, rarity: "Rare", desc: "Your next attack deals double damage.", effect: { kind: "double_next_attack" } },
